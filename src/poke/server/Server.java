...
public class Server {
	...
	public static ServerConf sconf;
	 ...
	 * @param cfg
	 */
	public Server(File cfg){//}, File cfg1) {
		init(cfg);
		//initCluster(cfg1);
	}
	...
	/*	else if (!cfg1.exists()) {
			...
			Server.logger.error("No Configuration files: ");
			System.exit(2);
		}
	*/	Server svr = new Server(cfg);//,cfg1);
		svr.run();
