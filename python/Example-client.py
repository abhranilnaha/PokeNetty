...
def sendMsg(msg_out, port, host, s):
...
if __name__ == '__main__':
    ...
    if input == "1":
        ...
        result = sendMsg(signupJob, port, host, s)
        ...
        while login==False:
            ...
            result = sendMsg(signinJob, port, host, s)
    ...
    while True:
        ...
        if input == "1":
            ...
            result = sendMsg(courseDescJob,  port, host, s)
            if result.body.job_status.status == 2:
    ...
    #            print result.body.job_status
        ...
        if input == "2":
            ...
            while (count < 100000):
                ...
                result = sendMsg(listCoursesJob,  port, host, s)
